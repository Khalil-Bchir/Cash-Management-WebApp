...
-- AddForeignKey
ALTER TABLE "ItemPayment" ADD CONSTRAINT "ItemPayment_orderProductId_fkey" FOREIGN KEY ("orderProductId") REFERENCES "OrderProduct"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
